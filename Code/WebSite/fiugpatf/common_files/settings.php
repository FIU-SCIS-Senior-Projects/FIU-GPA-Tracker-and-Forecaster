...
if($action == "prepareTable") {
	if (isset($_SESSION['username'])) {
		...
		array_push($output, array("Import PDF", '<form id="PDFimport" action="settings.php" enctype="multipart/form-data" method="post"><input type="file" name="file" id="Whatif"><input type="hidden" name="action" value="importWhatif"></form>'));
		if($admin == 1)
		{
